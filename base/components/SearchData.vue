<script setup>
const {icon, title, data, selectMulti} = defineProps(['icon', 'title', 'columns', 'data', 'selectMulti'])
...
<template>
  <div>
    ...
    <UButton v-else :icon="icon ||'heroicons:ellipsis-horizontal-20-solid'" @click="isOpen = true"/>
